...
<p align="justify">  The report analyzes Greenhouse Gas (GHG) emissions in Redwood City. Vehicle emissions and building emissions are considered as main GHG contributors. We compute the commute emissions based on block group (cbg) granularity to get higher accuracy. LODES 2013 to 2019 data are used to calculate commute emissions for the city as both an origin and destination. Residential and commercial electricity and gas usage from 2013 to 2019  data (PG&E) at the ZIP code level is used to estimate the building GHG emissions. We also analyze the effect of EV adoption on GHG emissions with an exponential decay model.
 </p>
